...
class StudentsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('action', function($row) {
                $url = route('teacher.student.edit', ['id' => $row->id]);
                $delete = route('teacher.student.single_destroy', ['id' => $row->id]);
    ...
    {
        $teacher = Auth::user();
        return $model->role(RoleEnum::STUDENT)->where('school_id', $teacher->school_id);
    }

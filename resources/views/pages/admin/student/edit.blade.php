...
<div class="content container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="card mb-3">
                <form id="form-student" action="{{ route('admin.student.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                    <div class="card-header card-header-content-between">
                        <h3 class="card-header-title">Data Siswa</h3>
                        @if (isset($data))
                            <button type="button" class="btn btn-soft-danger default_delete_button" data-endpoint="{{ route('admin.student.single_destroy', ['id' => $data->id]) }}" data-text="<i class='bi-trash me-2'></i> Hapus" data-text-loading="Menghapus">

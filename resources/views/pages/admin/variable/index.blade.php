...
@section('title', 'Data Vraiabel Assesment | Bioadaptiveclass')
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <h1 class="page-header-title">Data Variabel <span class="badge bg-soft-dark text-dark ms-2">{{ $variable_count }}</span></h1>
                ...
                <div>
                    <a class="btn btn-primary" href="{{ route('admin.variable.edit') }}">

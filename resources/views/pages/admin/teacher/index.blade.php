...
@section('title', 'Data Guru | Bioadaptiveclass')
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <h1 class="page-header-title">Data Guru <span class="badge bg-soft-dark text-dark ms-2">{{ $teacher_count }}</span></h1>
                ...
                <div>
                    <a class="btn btn-primary" href="{{ route('admin.teacher.edit') }}">

...
@section('title', 'Data Sumber Belajar | Bioadaptiveclass')
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    <h1 class="page-header-title">Data Sumber Belajar <span class="badge bg-soft-dark text-dark ms-2">{{ $learning_resource_count }}</span></h1>
                ...
                <div>
                    <a class="btn btn-primary" href="{{ route('teacher.learning-resource.edit') }}">
                        <i class="bi bi-plus-square-fill me-sm-2"></i>
                        <span class="d-none d-sm-inline">Tambah Sumber Belajar</span>
                    </a>
                </div>
            </div>
        </div>
        ...
        @include('components.datatable', [
            'search_text' => 'Cari sumber belajar...',
            'table' => $dataTable,
            'show_filter' => true
        ])
        {{-- End DataTable --}}

...
{{-- Set page title --}}
@section('title')
    {{ isset($data) ? 'Ubah Siswa: ' . $data->name : 'Tambah Siswa' }}
@endsection
...
<div class="content container-fluid">
    <div class="d-flex align-items-center mb-3">
        <a href="{{ route('teacher.student.index') }}" class="btn btn-white">
            <i class="bi bi-arrow-left"></i>
        </a>
        <div class="ms-3">
            <h3 class="card-header-title">
                <i class="bi-people me-2"></i>
                {{ isset($data) ? 'Ubah' : 'Tambah' }} Siswa
            </h3>
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="card mb-3">
                <form id="form-student" action="{{ route('teacher.student.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                    <div class="card-header card-header-content-between">
                        <h3 class="card-header-title">Data Siswa</h3>
                        @if (isset($data))
                            <button type="button" class="btn btn-soft-danger default_delete_button" data-endpoint="{{ route('teacher.student.single_destroy', ['id' => $data->id]) }}" data-text="<i class='bi-trash me-2'></i> Hapus" data-text-loading="Menghapus">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <label for="name" class="col-sm-4 col-md-3 col-form-label form-label">Nama Siswa <span class="text-danger">*</span> </label>
...
<script>
    ...
    addFormEditedEventHandler('#form-student');

...
<div class="content container-fluid">
    <div class="d-flex align-items-center mb-3">
        <a href="{{ route('teacher.learning-objective.index') }}" class="btn btn-white">
            <i class="bi bi-arrow-left"></i>
        </a>
        <div class="ms-3">
            <h3 class="card-header-title">
                <i class="bi-people me-2"></i>
                {{ isset($data) ? 'Ubah' : 'Tambah' }} Tujuan Pembelajaran
            </h3>
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="card mb-3">
                <form id="form-learning_objective" action="{{ route('teacher.learning-objective.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                    <div class="card-header card-header-content-between">
                        <h3 class="card-header-title">Data Tujuan Pembelajaran</h3>
                        @if (isset($data))
                            <button type="button" class="btn btn-soft-danger default_delete_button" data-endpoint="{{ route('teacher.learning-objective.single_destroy', ['id' => $data->id]) }}" data-text="<i class='bi-trash me-2'></i> Hapus" data-text-loading="Menghapus">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            <label for="title" class="col-sm-4 col-md-3 col-form-label form-label">Judul Tujuan Pembelajaran <span class="text-danger">*</span> </label>
                        ...
                        <div class="row mb-4">
                            <label for="content" class="col-sm-4 col-md-3 col-form-label form-label">Content <span class="text-danger">*</span></label>
                            <div class="col-sm-8 col-md-9">
...
<script>
    @if(session()->has('alert.learning_objective.success'))
    SweetAlert.success('Berhasil', '{{ session()->get('alert.learning_objective.success') }}');
    @endif

    initInputResetEventHandler();
    addFormEditedEventHandler('#form-learning_objective');
